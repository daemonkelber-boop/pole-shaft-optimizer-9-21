...
with tab3:
    ...
    if not tmp_path:
        ...
        try:
            ...
            default_idx3 = all_cases3.index(gov_case3) if gov_case3 in all_cases3 else 0

            sel_case3 = st.selectbox("Load case", all_cases3, index=default_idx3,
                                     key="lc3",
...
with tab4:
    ...
    if not tmp_path:
        ...
        try:
            ...
            from geometry import (PoleSpec as _PS4, Segment as _Seg4,
                                  build_sections as _bs4, thickness_from_wt as _tfw)
            ...
            if not df4.empty and df4['calc usage %'].notna().any():
                ...
                if gov_row['PLS usage %']:
                    ...
                    d2.metric("Difference", f"{gov_row['diff (pts)']:+.2f} pts")
